...
const finalPattern = inputs.eleven.data();
...
//     try std.testing.expectEqual(solutions.DayEleven_PartOne.value(), result);
// }
...
//     try std.testing.expectEqual(solutions.DayEleven_PartTwo.value(), result);
// }
