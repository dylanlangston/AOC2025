...
const finalPattern = inputs.ten.data();
...
//     try std.testing.expectEqual(solutions.DayTen_PartOne.value(), result);
// }
...
//     try std.testing.expectEqual(solutions.DayTen_PartTwo.value(), result);
// }
