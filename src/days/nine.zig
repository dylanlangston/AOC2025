...
const finalPattern = inputs.nine.data();
...
//     try std.testing.expectEqual(solutions.DayNine_PartOne.value(), result);
// }
...
//     try std.testing.expectEqual(solutions.DayNine_PartTwo.value(), result);
// }
