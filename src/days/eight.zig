...
const finalPattern = inputs.eight.data();
...
//     try std.testing.expectEqual(solutions.DayEight_PartOne.value(), result);
// }
...
//     try std.testing.expectEqual(solutions.DayEight_PartTwo.value(), result);
// }
