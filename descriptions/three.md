# For archival purposes only. [Please see the original puzzle here.](https://adventofcode.com/2025/day/3)

If you still want to see it, you can [get your puzzle input](../src/inputs/three.txt).
